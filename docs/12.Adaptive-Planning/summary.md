...
### 2. User Stories
- Mô tả chức năng từ góc nhìn người dùng
- Định dạng: "Là [vai trò], tôi muốn [hành động] để [lợi ích]"
- Được ước tính bằng điểm câu chuyện (story points) hoặc ngày lý tưởng
- Bao gồm tiêu chí chấp nhận để xác định khi nào hoàn thành

- Describing functionality from user perspective
- Format: "As a [role], I want [action] so that [benefit]"
- Estimated using story points or ideal days
- Includes acceptance criteria to define when complete

### 3. Lập kế hoạch Poker (Planning Poker)
- Kỹ thuật ước tính dựa trên đồng thuận
- Sử dụng thẻ có giá trị Fibonacci (1, 2, 3, 5, 8, 13, 21...)
- Thành viên nhóm chọn thẻ đồng thời để tránh bị ảnh hưởng
- Thảo luận để giải quyết những khác biệt lớn trong ước tính

- Consensus-based estimation technique
- Using cards with Fibonacci values (1, 2, 3, 5, 8, 13, 21...)
- Team members select cards simultaneously to avoid bias
- Discussion to resolve large differences in estimates

### 4. Bảng Kanban (Kanban Board)
- Bảng trực quan hiển thị công việc và trạng thái
- Các cột thường bao gồm: Backlog, Doing, Done, và các trạng thái khác
- Giới hạn WIP để cải thiện luồng công việc
- Cung cấp quan điểm tổng thể về tiến độ và rào cản

- Visual board showing work and status
- Columns typically include: Backlog, Doing, Done, and other statuses
- WIP limits to improve workflow
- Provides overview of progress and impediments
