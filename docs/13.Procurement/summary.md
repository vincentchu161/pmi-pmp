# Quản lý mua sắm trong dự án (Project Procurement Management)
...
- **Request for Quotation (RFQ)**: For simple, standard items.
...
### 2. Kiểm soát thay đổi hợp đồng (Contract Change Control)
...
- Careful contract drafting with clear terms
...
- Settling claims
- Updating records
- Archiving contract information
- Releasing resources

### 3. Bài học kinh nghiệm (Lessons Learned)
- Ghi lại những thực hành tốt nhất
- Ghi lại các vấn đề và giải pháp
- Chia sẻ bài học cho dự án trong tương lai
- Cập nhật tài sản quy trình tổ chức

- Documenting best practices
- Recording issues and solutions
- Sharing lessons for future projects
- Updating organizational process assets

## Vai trò của người quản lý dự án trong mua sắm (Project Manager's Role in Procurement)

- Phối hợp với bộ phận mua sắm/pháp lý của tổ chức
- Xác định các hạng mục cần mua sắm
- Đảm bảo yêu cầu rõ ràng
- Tham gia vào việc lựa chọn nhà cung cấp
- Giám sát hiệu suất nhà cung cấp
- Quản lý mối quan hệ với nhà cung cấp
- Kiểm soát thay đổi hợp đồng

- Coordinating with organizational procurement/legal departments
- Identifying items to be procured
- Ensuring clear requirements
- Participating in vendor selection
- Monitoring vendor performance
- Managing vendor relationships
- Managing contract changes

## Xu hướng mua sắm hiện đại (Modern Procurement Trends)

### 1. Mua sắm Agile (Agile Procurement)
- Hợp đồng lặp đi lặp lại và gia tăng
- Tập trung vào hợp tác với nhà cung cấp
- Thích ứng với thay đổi
- Đánh giá liên tục

- Iterative and incremental contracts
